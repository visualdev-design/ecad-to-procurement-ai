...
3. Packing slip is matched to PO  
...
8. Tracking is synced to order state  
...
- `shipped` refers to outbound shipment to end user  
...
- Write pricing results back into sheet  
- Write distributor selection per line item  
- Trigger checkout from sheet  
...
All models call the same OpenAPI backend.
...
- Full audit trail  
- Model 2 fulfillment enforcement  
